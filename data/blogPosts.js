export const PhilosophicalPosts = [
  {
    ...
    article: `
      <div>
        ...
        <p>It’s known that things can seem chaotic, when we don’t have sufficient knowledge of them. If you have ever worked with statistical data, you know that random variables, which are impossible to predict, can eventually be predictable, when you have enough data. This is the central limit theorem: ‘When the sample size is large enough, everything is normally distributed’. If you toss a coin 10 times, the standard deviation will be higher. However, if you repeat the experiment 1000000 times the mean will get closer and closer to 0.5.</p>
