export const PhilosophicalPosts = [
  {
    ...
    article: `
      <div>
        <p>When I was a child, my mum always kept telling me, "Everything has a pattern, sweetheart. You don’t see it, because you’re looking too closely." </p>
        <p>A couple of months ago, I read a book about sleep and there was a sentence that kept me awake at night. ‘Brain signals’, said the author, ‘...are chaotic.’ You cannot anticipate them. You cannot predict them. In fact, they are so random that, if you convert them into sound, which he did, you would find it impossible to dance.</p>
        <p>I couldn’t stop thinking about that because chaos and order, randomness and determinism are two main concepts that intellectually entertain me all the time.</p>
        <p>From where we are looking at the Cosmos, it seems like we are existing in a very chaotic system. However, science takes a quite deterministic position, well, at least it did prior to Quantum Mechanics. Causal Determinism implies that any state is determined by prior states. There is no true randomness in our reality, however, we are also too small to be able to make calculations to predict events. Therefore, the unpredictability of the universe was called pseudo-randomness. It’s random to us, but in reality, it’s an output determined by other preceding states, which are unknown to us.</p>
        <p>Let’s analyze ‘the die experiment’. Imagine having a die in your hand. Now close your eyes and roll the imaginary die. Without opening your eyes guess the number. What would be the probability of guessing the right number? "⅙" - you say. You’re absolutely right. However, what if I told you that the dice has some factory imperfections and one side is slightly heavier than the other ones. That information would make it easier for you to guess the result of the experiment, right?</p>
        <p>So, what do you think that has happened here? Just having some precise data about one variable of the process increased your probability of predicting the future. Cool, right?</p>
        <p>Then let’s move a little bit further and assume that we have a technology that is capable of accurately calculating all those variables, such as the viscosity of the air, the acceleration of gravity, the friction of the surface, the symmetry of the product, the angle of your hand, etc. What about now? What would be the probability of guessing the result right with all this information? Very high, right? After all, the dice didn’t just freely choose and decide which side to land on.</p>
        <p><i>“Theoretically the die throw is predictable, but the accuracy required for determining the initial position is so high that practically it approximates a random process.”</i></p>
        <p>Most of the time we talk about probabilities, not because we are dealing with fundamentally random processes. Instead, it's usually because we don't have all the information required to predict the outcome.</p>
        <p>In our experiment above, I asked you to guess the number without opening your eyes. What was your guess? Why did you choose that number? Or, it wasn’t a choice at all... it just appeared in your mind from nowhere. (?) If I ask you to think of a movie instantly, the first movie that will appear in your mind, won’t be the result of your rational thinking. Thoughts are simply appearing in our consciousness. We’re not authoring them, we cannot control them. Because this would require us to think them before we think them.</p>
        <p>Everything is an output of some other variables which themselves are an output of other variables which in their turn are also a product of some other previous variables…and so on. Everything is connected. Nothing is free.</p>
        <p>If you possessed the technology capable of precisely calculating every single influencing variable, it would be easier to predict our actions. It sounds like a science fiction movie, I know, but if you were god and you had a precise description of everything in our reality at a particular instant, or Artificial Intelligence capable of processing all the data and creating precise algorithms, then you would be able to predict the whole future.</p>
        <p>We are not in control. Our actions are not a product of free will, in fact, there is no such thing as free will. Our actions and thoughts are simply an output of different variables that are influenced by our genes, our physical development, the interactions we had with other people, events, hormones, the activity of individual neurons in our brain, etc. Where is the freedom in this? How can we be "free" as conscious creatures if everything that we consciously intend is caused by events in our brain which we are entirely unaware of?</p>
        <p>You didn’t choose your parents, your gender, the culture you grew up in, the time and place of your birth, most of your life experiences… you have no control over your genome, your hormones or the development of your brain. But,  your brain is making choices on the basis of preferences and beliefs that have been anchored into it over a lifetime. Of course, choices, efforts, intentions, and reasoning influence our behavior, however we have no prior control over our choices. In other words, we do not choose to choose what we choose. We are free to do what we desire, but where are those desires coming from? I know it sounds confusing. But it’s exciting, right?</p>
        <p>If determinism is true, the future is set. Everything that needs to happen, is going to happen. Think about the butterfly effect. Flapping its wings it already caused a typhoon in the future, which is going to happen. Being in control of our actions is just an illusion. We are not fooled by randomness. Maybe in a small picture our brain waves look random, because we’re observing just a small fraction of it. We are just like those puppets controlled by some other forces… we cannot see the controlling strings, we cannot see the pattern, because we are just... looking too closely.</p>
      </div>`,
  },
  {
    ...
    article: `
      <div>
        ...
        <p>
          Don’t you feel like floating in an unknown space without having a clue where you’re heading? It’s ok, I know. I know... I understand that it’s not fun to live like this. Why to create all this drama? We can live simple lives, have simple desires and leave quietly, as my mum recommends. But, once you have a
          love affair with chaos, there is no way back, you become chaos.
        </p>
        ...
        <p>
          When I first started questioning existence, I was wondering where the boundaries are. Because, I knew if I go beyond that I will get lost. Getting lost is scary, unknown is biologically not the most attractive place to be for us, human beings. But with time, it changed. I got lost without even getting beyond
          the boundaries, without even leaving the village, without even seeing the lines framing our reality. Do you understand what it means? Do you know that you can get lost without even losing the maps? Because there are no real maps? Of course there aren’t! There can’t be! They gave us the fake ones! Look at your
          life, look at the people around you… and lives and things, and priorities, desires, dreams, systems, laws… everything, everything is fake. Everything is imaginary. It’s just stories they make us believe. Believe. So that we can… live? Or serve? What are we doing here?
        </p>
        <p>
          Do you believe in stories? Good for you. That’s easy. Next time, try forcing yourself to give a meaning to those stories. I try too hard. I understand quite well that there is no pain like the existential one. No monster under our bed is scarier than those nihilistic thoughts in our mind. Because once you
          lose meaning, you lose everything. You don’t feel. Feelings are beautiful. Do you know that? Of course you know. It’s exciting. It makes every molecule in your body move. But, there is other side, which is deeper, which is darker, which comes with an immense philosophical understanding of life, which is not
          just sadness. Sadness is a feeling. This is a kind of indifference, which is more painful… although there are no feelings involved… or… maybe, there are too many feelings involved creating the darkest chaos in your universe, which is inside you, which is you.
        </p>
        <p>
  ...
  },
  {
    ...
    article: `
      <div>
        ...
        <p>
          I don’t need to know your whole story to understand you. You are me. I can feel you. Can’t you feel the connection? Think about it. Right now. Or… fuck thinking, feel me. I’m sitting here, writing… pausing, looking at my hands, at my visible bones… realizing how tired I am, how delusional I am, because I
          haven’t normally slept for the last couple of days, or years… I don’t remember. It’s cold outside. It’s dark outside. I’m alone…. But there are people, talking inside my mind. Or it’s just me? I guess I’m too loud… Can you hear me?
        </p>
        ...
        <p>
          It’s sad you know… because you really get involved in life, you actually try, you plan, you feel, you trust, you forget… and suddenly, you’re back to the start point again. Why the hell we’re always making circles? Why can’t we just lie to ourselves and be done with it? Why do we choose to hurt ourselves?
        </p>
        ...
        <p>
          Let the silence in, sweetheart. It’s the only way, to find yourself… to face your darkness. Darkness is not scary. Nothing is scary. It’s just there, waiting for you to discover it. Don’t try to understand it… this is our problem. We try to understand everything. Rationalizing your metaphysical nihilism not
          only destroys the magic of its elegant melancholy, its warm familiarity, it also puts you on that hamster wheel again. Pretending… playing… keeping busy… not sleeping…. and suffering.
        </p>
        ...
        <p>
          Accepting without protesting… without fighting. Can you do that for yourself? It’s just what it’s, you know. We cannot understand everything, because we’re too small. We are too small. I know how it feels to desire the impossible. I know how it feels to see the limits, but deep down not to feel them. I know
          how it feels to be alone in the middle of nothingness and feel the fear in your bones. I know how it feels to get lost. I know you’re tired. You are me. That’s your reality, that’s our reality … always trying, always moving… full of emotions… and empty at the same time. I know… I know…
        </p>
        <p>…</p>
  ...
  },
  {
    ...
    article: `
      <div>
        ...
        <p>
          ‘Pleasure’ is a biological phenomenon. You feel good when certain hormonal processes happen in your physical body and they only serve to the goal of evolution. ‘Good feelings’ are not about being happy, it’s about survival, which helps you to stay alive and reproduce. Food helps you to survive, therefore
          eating something, especially when it’s high on calories and energy, feels good. Just think about that, what would happen to humanity, if we just eliminate the ‘orgasm detail’ from sex? …or just remove the hormones that make us attracted to the opposite sex? We would extinct. Nature has a simple method to keep
          us under control and it’s our ‘feelings’. How does it feel to be manipulated from inside? How does it feel to realize we are not that special at all?
        </p>
        <p>Drink!</p>
        ...
        <p>
          ...
          care about you… emptiness is the essence of the whole existence. What a life! Huh?
        </p>
        <p>Drink.</p>
        ...
        <p>
          This is the first day of the rest of your life. Do something uncomfortable… something risky. Do something that you have been avoiding for a long time. Get the hell out of your comfort zone! Do you want to change something? Change it now! Do you want to achieve something? Go for it. Do you need to cry? I’m
          here. No need to be ashamed of tears, for tears bear witness that a man has the greatest of courage, the courage to suffer.
        </p>
